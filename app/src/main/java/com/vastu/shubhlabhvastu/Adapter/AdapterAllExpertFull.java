...
import com.vastu.shubhlabhvastu.Activity.QueryForm;
...
public class AdapterAllExpertFull extends RecyclerView.Adapter<AdapterAllExpertFull.ViewHolder>    {

    private Activity activity;
    private ArrayList<ModelAllExpert> modelAllExpert;
    public Utility utl;

    public AdapterAllExpertFull(Activity activity, ArrayList<ModelAllExpert> modelAllExpert) {
        this.activity = activity;
        this.modelAllExpert = modelAllExpert;
    }

    @Override
    public AdapterAllExpertFull.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(activity).inflate(R.layout.holder_expert_list_full, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterAllExpertFull.ViewHolder holder, int position) {
