...
public class AdapterAllExpert extends RecyclerView.Adapter<AdapterAllExpert.ViewHolder>    {

    private Activity activity;
    private ArrayList<ModelAllExpert> modelAllExpert;
    public Utility utl;

    public AdapterAllExpert(Activity activity, ArrayList<ModelAllExpert> modelAllExpert) {
        this.activity = activity;
        this.modelAllExpert = modelAllExpert;
    }

    @Override
    public AdapterAllExpert.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(activity).inflate(R.layout.holder_expert_list, parent, false));
    }

    @Override
    public void onBindViewHolder(AdapterAllExpert.ViewHolder holder, int position) {
