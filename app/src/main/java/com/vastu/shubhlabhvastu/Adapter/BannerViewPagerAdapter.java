...
public class BannerViewPagerAdapter extends PagerAdapter {
   ...
   List<ModelScreenItem> mListScreen;
    ...
    public BannerViewPagerAdapter(Context mContext, List<ModelScreenItem> mListScreen) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View layoutScreen = inflater.inflate(R.layout.layout_banner_home,null);

        ImageView imgSlide = layoutScreen.findViewById(R.id.iv_img);
        TextView title = layoutScreen.findViewById(R.id.tv_title);
        TextView description = layoutScreen.findViewById(R.id.tv_summary);
